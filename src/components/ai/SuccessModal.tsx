...
export default function SuccessModal({
  ...
  const navigateToEditor = (url: string, newTab: boolean) => {
    resetProvisioning();
    setPendingOpen(null);
  ...
  const openEditor = async (newTab: boolean) => {
    ...
    setPendingOpen({ url: editorUrl, newTab });
  ...
  return (
    <>
        ...
        >
          ...
          <div className="space-y-2">
            <button
              ...
              disabled={!editorUrl || isProvisioning}
      ...
      <StoreProvisioningGate
        ...
        onContinueAnyway={() => {
          if (pendingOpen) {
            navigateToEditor(pendingOpen.url, pendingOpen.newTab);
          }
        }}
      />
    </>
